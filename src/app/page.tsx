              ...
              <div className="relative w-full h-[400px] xl:h-[460px] mt-8">
                ...
                <div className="absolute inset-0 bg-white dark:bg-surface-dim-dark rounded-3xl shadow-2xl flex items-center justify-center border border-slate-200 dark:border-white/5">
                  <div className="text-center space-y-6 p-8">
                    <div className="w-32 h-32 mx-auto rounded-3xl bg-gradient-to-br from-primary via-primary-dark to-secondary flex items-center justify-center shadow-2xl shadow-primary/30 rotate-3 hover:rotate-0 transition-transform duration-500">
